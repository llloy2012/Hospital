 ...
 * 
* @ClassName: ServerDao 
* @Description: TODO(服务器的数据库的基本方法) 
* @author wanghailong 81813780@qq.com 
* @date 2012-12-18 上午9:00:51 
*
 */
public class ServerDao {
	...
	* @throws
	...
	public static String getInsertOrders_costs(Map<String, String> map){
		...
		buffer.append("insert into orders_costs ( item_name,amount,units,item_code,item_class,item_no,"+
					           "order_sub_no,order_no,visit_id,patient_id,costs,item_spec,backbill_rule)  "+
                      "values(");
	 ...
	 * 
	* @Title: getInsert 
	* @Description: TODO(插入检查预约记录表信息) 
	* @param @param 表名 exam_appoints
	* @param @param 字段1
	* @param @param 字段2
	* @param @return    设定文件 
	* @return String    返回类型 
	* @throws 
	 ...
	 * 
	* @Title: getInsert 
	* @Description: TODO(插入检查项目记录表信息) 
	* @param @param 表名exam_items
	* @param @param 字段1
	* @param @param 字段2
	* @param @return    设定文件 
	* @return String    返回类型 
	* @throws 
	 ...
	 * 
	* @Title: getInsert 
	* @Description: TODO(插入检验主记录) 
	* @param @param 表名lab_test_master
	* @param @param 字段1
	* @param @param 字段2
	* @param @return    设定文件 
	* @return String    返回类型 
	* @throws 
	 ...
	 * 
	* @Title: getInsert 
	* @Description: TODO(插入检验项目表) 
	* @param @param 表名lab_test_items
	* @param @param 字段1
	* @param @param 字段2
	* @param @return    设定文件 
	* @return String    返回类型 
	* @throws 
	 ...
	 * 
	* @Title: getInsert 
	* @Description: TODO(插入到待发药住院处方主记录表) 
	* @param @param 表名doct_drug_presc_master
	* @param @param 字段1
	* @param @param 字段2
	* @param @return    设定文件 
	* @return String    返回类型 
	* @throws 
	 ...
	 * 
	* @Title: getInsert 
	* @Description: TODO(插入到待发药住院处方明细记录表) 
	* @param @param 表名doct_drug_presc_detail
	* @param @param 字段1
	* @param @param 字段2
	* @param @return    设定文件 
	* @return String    返回类型 
	...
	* @throws
	 */
	//select group_name,group_code from staff_group_dict where group_class='病区医生'
