	...
	* @throws
	...
	public static ArrayList<PatientEntity> init(ArrayList<DataEntity> arrayList){
		...
		for (int i = 0; i < arrayList.size(); i++) {
			...
			entity.dept_code=arrayList.get(i).get("dept_code");
			entity.bed_no=arrayList.get(i).get("bed_no");
			entity.diagnosis=arrayList.get(i).get("diagnosis");
			entity.doctor_in_charge=arrayList.get(i).get("doctor_in_charge");
			entity.patient_id=arrayList.get(i).get("patient_id");
			entity.visit_id=arrayList.get(i).get("visit_id");
			entity.prepayments=arrayList.get(i).get("prepayments");
			entity.name=arrayList.get(i).get("name");
			entity.sex=arrayList.get(i).get("sex");
			entity.name_phonetic=arrayList.get(i).get("name_phonetic");
			entity.date_of_birth=arrayList.get(i).get("date_of_birth");
			entity.identity=arrayList.get(i).get("identity");
			entity.mailing_address=arrayList.get(i).get("mailing_address");
			entity.zip_code=arrayList.get(i).get("zip_code");
			entity.phone_number_home=arrayList.get(i).get("phone_number_home");
