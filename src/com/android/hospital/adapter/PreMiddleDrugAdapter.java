...
* @Description: TODO(中药房的药品adapter，含检索功能) 
* @author wanghailong 81813780@qq.com 
* @date 2012-12-18 下午11:46:08 
*
 */
public class PreMiddleDrugAdapter extends ArrayAdapter<DrugEntity> implements Filterable{
	...
	public PreMiddleDrugAdapter(Context context,int textViewResourceId,ArrayList<DrugEntity> arrayList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView==null) {
			convertView=mInflater.inflate(R.layout.fragment_add_prescription_list_item, null);
		...
		viewHolder.tev5.setText(item.storage_name);
		viewHolder.tev6.setText(item.dose_per_unit);
		viewHolder.tev7.setText(item.dose_units);
		viewHolder.tev8.setText(item.is_basic);
		return convertView;
	}
	...
	private class ViewHolder{
		public TextView tev1,tev2,tev3,tev4,tev5,tev6,tev7,tev8;
	}
